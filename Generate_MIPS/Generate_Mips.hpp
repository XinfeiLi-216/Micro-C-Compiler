        ...
        void operations_in_memory(int idx1,int idx2,operations operation){
            switch (operation){
                ...
                case 3:
                    break;
                case 4:
                    text_segment.push_back("lw $s1,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("lw $s2,"+to_string(idx2*4)+"($t0)");
                    text_segment.push_back("add $s0,$s1,$s2");
                    text_segment.push_back("sw $s0,"+to_string(idx1*4)+"($t0)");
                    break;
                case 5:
                    text_segment.push_back("lw $s1,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("lw $s2,"+to_string(idx2*4)+"($t0)");
                ...
                case 7:
                    ...
                    text_segment.push_back("sw $lo,"+to_string(idx1*4)+"($t0)");
                    break;
                case 8:
                    text_segment.push_back("lw $s1,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("lw $s2,"+to_string(idx2*4)+"($t0)");
                ...
                case 9:
                    ...
                    text_segment.push_back("sw $zero,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("beq $t3,$t4,gt_not_label"+to_string(gt_not_count));
                    text_segment.push_back("beq $t1,$t2,gt_not_label"+to_string(gt_not_count));    
                    text_segment.push_back("sw $t4,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("gt_not_label"+to_string(gt_not_count++)+":");                 
                    break;
                case 10:
                    text_segment.push_back("lw $s1,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("lw $s2,"+to_string(idx2*4)+"($t0)");
                    text_segment.push_back("li $t3,1");
                    text_segment.push_back("sw $t3,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("beq $s1,$s2,equal_label"+to_string(equal_count));
                    text_segment.push_back("sw $zero,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("equal_label"+to_string(equal_count++)+":");
                    break;
                case 11:
                    text_segment.push_back("lw $s1,"+to_string(idx1*4)+"($t0)");
                    text_segment.push_back("lw $s2,"+to_string(idx2*4)+"($t0)");
